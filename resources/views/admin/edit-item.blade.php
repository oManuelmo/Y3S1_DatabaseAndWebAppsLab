...
<script src="https://cdnjs.cloudflare.com/ajax/libs/cropperjs/1.5.13/cropper.min.js"></script>
    ...
    <div style="margin-bottom: 5em;" class="container edit-item">
        ...
        <form method="POST" action="{{ route('item.update', $item->itemid) }}" enctype="multipart/form-data">
            ...
            <input id="name" type="text" name="name" maxlength="100" value="{{ old('name', $item->name) }}" required>
            @if ($errors->has('name'))
                <span class="error">
            ...
            @if ($errors->has('initialprice'))
                ...
                {{ $errors->first('initialprice') }}</span>
            @endif
            <br>
            ...
            <input type="text" id="new_artist_name" name="new_artist_name" maxlength="100" placeholder="Enter a new artist's name" value="{{ old('new_artist_name') }}" style="display: none;">
            ...
            <span class="error">{{ $errors->first('new_artist_name') }}</span>
            @endif
            <br>
            ...
            <div id="image-upload-container">
                ...
                @for ($i = 0; $i < 5; $i++)
                    <div class="image-upload" id="image-upload-{{ $i + 1 }}" style="{{ $i > count($images) ? 'display: none;' : '' }}">
